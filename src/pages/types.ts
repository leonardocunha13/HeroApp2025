...
export type CellPropertyStyledFunction<T extends PropTypes> = (
  x: number,
  y: number,
...
export type CellPropertyFunction<T extends PropTypes> = (
  x: number,
  y: number,
) => T;
export type RowOrColumnPropertyFunction<T extends PropTypes> = (
  rowOrColIndex: number,
) => T;

export type CellPropertyStyled<T extends PropTypes> =
  | T
  | T[][]
  | CellPropertyStyledFunction<T>;
export type RowOrColumnPropertyStyled<T extends PropTypes> =
  | T
  | T[]
  | RowOrColumnPropertyStyledFunction<T>;

export type CellProperty<T extends PropTypes> =
  | T
  | T[][]
  | CellPropertyFunction<T>;
export type RowOrColumnProperty<T extends PropTypes> =
  | T
  | T[]
